import React, { useCallback, useEffect, useMemo, useState, FC
  } from 'react';
  ...
  export const CardOrder: FC<TCardOrderProps> = ({ orderDetails, maxIngredientsOnPreview = 5, showOrderStatus = false }) => {
